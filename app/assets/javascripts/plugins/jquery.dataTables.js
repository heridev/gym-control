	...
	_oExt.oPagination = {
		...
		"two_button": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				jQuery(nPrevious).bind( 'selectstart.DT', function () { return false; } );
				jQuery(nNext).bind( 'selectstart.DT', function () { return false; } );
		...
		"full_numbers": {
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				for ( i=iStartButton ; i<=iEndButton ; i++ )
				{
					if ( iCurrentPage != i )
					{
						sList += '<span class="'+oClasses.sPageButton+' number">'+i+'</span>';
					}
					else
					{
						sList += '<span class="'+oClasses.sPageButtonActive+' number">'+i+'</span>';
					}
				}
				...
				for ( i=0, iLen=an.length ; i<iLen ; i++ )
				{
					...
					jQuery('span', qjPaginateList).bind( 'click.DT', fnClick ).bind( 'mousedown.DT', fnFalse )
