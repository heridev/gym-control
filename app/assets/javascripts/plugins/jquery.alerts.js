...
(function(jQuery) {
	...
	jQuery.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					jQuery("#popup_message").after('<div id="popup_panel" class="clearfix"><input class="btn green mr15" type="button" value="' + jQuery.alerts.okButton + '" id="popup_ok" /></div>');
				...
				break;
				case 'confirm':
					jQuery("#popup_message").after('<div id="popup_panel" class="clearfix"><input class="btn green mr15" type="button" value="' + jQuery.alerts.okButton + '" id="popup_ok" /> <input class="btn red mr15" type="button" value="' + jQuery.alerts.cancelButton + '" id="popup_cancel" /></div>');
					jQuery("#popup_ok").click( function() {
						jQuery.alerts._hide();
				...
				break;
				case 'prompt':
					jQuery("#popup_message").append('<br /><input type="text" size="30" class="dialog_text" id="popup_prompt" />').after('<div id="popup_panel" class="clearfix"><input class="btn green mr15" type="button" value="' + jQuery.alerts.okButton + '" id="popup_ok" /> <input class="btn red mr15" type="button" value="' + jQuery.alerts.cancelButton + '" id="popup_cancel" /></div>');
					jQuery("#popup_prompt").width( "265px");
					jQuery("#popup_ok").click( function() {
